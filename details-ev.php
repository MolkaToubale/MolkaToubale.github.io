  ...
  <section id="fournisseur">
    ...
    <div class="row mx-auto container-fluid">
      <?php foreach ($articles as $article) { ?>
        ...
        <img class="img-tab" src="images/upload/articles/<?php echo $article['image1']; ?>" alt="placeholder">
          <div class="star ">
  ...
  <section id="fournisseur">
    ...
    <div class="row mx-auto container-fluid">
      <?php foreach ($equipes as $equipe) { ?>
        <div class="produit text-center col-lg-3 col-md-4 col-12">
        <img class="img-tab" src="images/upload/equipes/<?php echo $equipe['image']; ?>"  alt="placeholder">
          <div class="star ">
