    ...
    <table width="100%">
      ...
      <tbody>
        <?php foreach ($articlesVente as $article) { ?>
          <tr>
            <td>
              <img class="img-tab" src="images/upload/articles/<?php echo $article['image1']; ?>" width="70%" alt="placeholder">
            </td>
            <td>
    ...
    <table width="100%">
      ...
      <tbody>
        <?php foreach ($equipeArticles as $equipe) { ?>
          <tr>
            <td>
            <img class="img-tab" src="images/upload/equipes/<?php echo $equipe['image']; ?>" width="70%" alt="placeholder">
            </td>
            <td>
